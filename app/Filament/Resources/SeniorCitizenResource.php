                    ...
                    ->schema([
                        Forms\Components\Toggle::make('is_active')
                            ...
                            ->afterStateUpdated(function (callable $set, $state) {
                                $set('registry_number_disabled', $state); // Enable or disable registry_number based on Toggle state
                            }),
                        Forms\Components\TextInput::make('registry_number')
                            ->disabled(fn ($get) => $get('registry_number_disabled') ?? true) // Check the state to enable/disable
                            ->required(),
                    ]),
